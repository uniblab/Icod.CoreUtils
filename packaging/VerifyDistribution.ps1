...
$routerProjectPath = Join-Path $repositoryRoot 'coreutils/Icod.CoreUtils.Router.csproj'
$solutionPath = Join-Path $repositoryRoot 'Icod.CoreUtils.sln'
$projectMap = Get-CoreUtilsProjectMap
$commandNames = @($projectMap.Keys)
