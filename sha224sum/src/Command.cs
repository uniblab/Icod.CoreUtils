...
/// <summary>
/// Computes or verifies SHA224 message digests.
/// </summary>
public static class Command {

	private static readonly DigestCommandSettings Settings = new() {
		Algorithm = ChecksumAlgorithmKind.Sha224,
		DefaultLengthBits = 224,
		DisplayName = "SHA224",
		PrintUsage = PrintUsage,
		ProgramName = "sha224sum",
		SupportsLength = false,
		VersionText = "Icod.CoreUtils.Sha224Sum 1.0"
	};

	/// <summary>
	/// Executes <c>sha224sum</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>sha224sum</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>sha224sum</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
	...
	private static void PrintUsage(
		...
		output.WriteLine(
			"Print or check SHA224 checksums."
		);
		output.WriteLine();
		output.WriteLine(
