...
/// <summary>Provides the thin long-format <c>vdir</c> profile over the shared listing engine.</summary>
public static class Command {
	/// <summary>Runs <c>vdir</c> asynchronously.</summary>
	...
	/// <summary>Runs <c>vdir</c> synchronously for compatibility with existing callers.</summary>
	/// <param name="args">Command-line arguments.</param>
	/// <param name="stdin">Optional standard input.</param>
	/// <param name="stdout">Optional standard output.</param>
	/// <param name="stderr">Optional standard error.</param>
