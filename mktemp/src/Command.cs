...
public static class Command {
	...
	/// <summary>Runs the command synchronously using optionally injected streams.</summary>
	...
	/// <summary>Runs the command using injected output and error streams.</summary>
	...
	/// <summary>Runs the command using injected creation and environment providers.</summary>
