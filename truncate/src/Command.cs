...
public static class Command {
	...
	/// <summary>
	/// Executes <c>truncate</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>truncate</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>truncate</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
	...
	/// <param name="args">The command-line arguments, excluding the executable name.</param>
	/// <param name="context">The command context that supplies standard streams, diagnostics, and cancellation.</param>
	/// <param name="platform">The platform implementation used for file-size operations.</param>
	/// <returns>The GNU-compatible process exit status: zero for successful command execution and nonzero for a usage or operational failure.</returns>
	/// <exception cref="ArgumentNullException"><paramref name="context"/> is <see langword="null"/>.</exception>
	...
	private static bool TryMultiplyByBlockSize(
		...
		var value = new BigInteger( specification.Magnitude ) * blockSize;
		if (
			value < long.MinValue
			|| value > long.MaxValue
		) {
