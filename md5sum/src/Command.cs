...
/// <summary>
/// Computes or verifies MD5 message digests.
/// </summary>
public static class Command {

	private static readonly DigestCommandSettings Settings = new() {
		Algorithm = ChecksumAlgorithmKind.Md5,
		DefaultLengthBits = 128,
		DisplayName = "MD5",
		PrintUsage = PrintUsage,
		ProgramName = "md5sum",
		SupportsLength = false,
		VersionText = "Icod.CoreUtils.MD5Sum 1.0"
	};

	/// <summary>
	/// Executes <c>md5sum</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>md5sum</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>md5sum</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
