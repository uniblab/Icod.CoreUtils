...
public static class Command {
	...
	/// <summary>
	/// Executes <c>wc</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>wc</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>wc</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
