...
public static class Command {
	...
	private static readonly BaseEncodingCommandSettings Settings = new() {
		ProgramName = "base64",
		VersionText = "Icod.CoreUtils.Base64 1.0",
		FixedEncoding = BaseEncodingKind.Base64,
		PrintUsage = PrintUsage
	};

	/// <summary>
	/// Executes <c>base64</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>base64</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>base64</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
