...
Completion Gate P1 extends the system-provider coverage to Linux queued signal delivery and verifies that unsupported hosts advertise that boundary explicitly.
