...
public static class Command {
	...
	/// <summary>
	/// Executes <c>sha256sum</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>sha256sum</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>sha256sum</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
