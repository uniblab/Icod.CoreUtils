...
/// <summary>
/// Computes or verifies SHA384 message digests.
/// </summary>
public static class Command {

	private static readonly DigestCommandSettings Settings = new() {
		Algorithm = ChecksumAlgorithmKind.Sha384,
		DefaultLengthBits = 384,
		DisplayName = "SHA384",
		PrintUsage = PrintUsage,
		ProgramName = "sha384sum",
		SupportsLength = false,
		VersionText = "Icod.CoreUtils.Sha384Sum 1.0"
	};

	/// <summary>
	/// Executes <c>sha384sum</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>sha384sum</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>sha384sum</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
