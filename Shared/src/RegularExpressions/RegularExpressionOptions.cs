...
/// <summary>Controls GNU basic regular-expression compilation and matching.</summary>
public sealed record RegularExpressionOptions {
	...
	/// <summary>
	/// Gets or initializes whether line-feed characters delimit logical lines for anchors and are excluded by dot and negated bracket expressions.
	/// </summary>
