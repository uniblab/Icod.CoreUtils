...
/// <summary>Provides the thin <c>ls</c> executable profile over the shared listing engine.</summary>
public static class Command {
	/// <summary>Runs <c>ls</c> asynchronously.</summary>
	...
	/// <summary>Runs <c>ls</c> synchronously for compatibility with existing callers.</summary>
	/// <param name="args">Command-line arguments.</param>
	/// <param name="stdin">Optional standard input.</param>
	/// <param name="stdout">Optional standard output.</param>
	/// <param name="stderr">Optional standard error.</param>
