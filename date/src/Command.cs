...
/// <summary>
/// Implements GNU-compatible <c>date</c> and formats, parses, or reports date and time values.
/// </summary>
/// <remarks>
/// Date and time acquisition is injectable so formatting and relative-time tests remain deterministic.
/// </remarks>
public static class Command {
	...
	/// <summary>
	/// Executes <c>date</c> synchronously with optional standard-stream substitution.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>date</c> asynchronously with optional injected standard streams.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Executes <c>date</c> asynchronously using a complete shared command context.
	/// </summary>
	/// <remarks>
	...
	/// <param name="dateTimeProvider">The provider used to obtain the current and converted date-time values.</param>
	/// <returns>The GNU-compatible process exit status: zero for successful command execution and nonzero for a usage or operational failure.</returns>
