...
public static class Command {
	...
	/// <summary>
	/// Runs the command synchronously for compatibility with legacy callers.
	/// </summary>
	...
	/// <summary>
	/// Runs the command with supplied text and binary streams.
	/// </summary>
	...
	/// <summary>
	/// Runs the command using an injected command context.
	/// </summary>
